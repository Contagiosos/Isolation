...
#include "Sala_Base__pf1773622777.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/TopDownCPP/Blueprints/Sala_Base.Sala_Base_C", OverrideNativeName="Sala_Base_C"))
class ASala_Base_C__pf1773622777 : public AActor
{
public:
	GENERATED_BODY()
	...
	ASala_Base_C__pf1773622777(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Sala_Base__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Sala_Base__pf_1(int32 bpp__EntryPoint__pf);
