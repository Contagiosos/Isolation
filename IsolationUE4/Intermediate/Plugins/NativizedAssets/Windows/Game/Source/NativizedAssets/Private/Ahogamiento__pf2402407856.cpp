...
UAhogamiento_C__pf2402407856::UAhogamiento_C__pf2402407856(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UAhogamiento_C__pf2402407856::StaticClass() == GetClass()))
	{
		UAhogamiento_C__pf2402407856::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__BarraFiltro__pf = nullptr;
	bpv__BarraOxigeno__pf = nullptr;
	bpv__NivelDeOxigeno__pf = 1.000000f;
	bpv__NivelDeFiltro__pf = 0.100000f;
	bpv__bAhogandose__pf = false;
	bpv__bEstaVivo__pf = true;
	bpv__RecuperacionOxigeno__pf = 0.090000f;
	bpv__DevanecimientoDeFiltro__pf = 0.015000f;
	bpv__DesvanecimientoDeOxigeno__pf = 0.030000f;
	bHasScriptImplementedPaint = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void UAhogamiento_C__pf2402407856::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UAhogamiento_C__pf2402407856::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<UCanvasPanelSlot>(__Local__1, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__3->LayoutData.Offsets.Left = 20.000000f;
	__Local__3->LayoutData.Offsets.Top = 68.000000f;
	__Local__3->LayoutData.Offsets.Right = 636.000000f;
	__Local__3->LayoutData.Offsets.Bottom = 120.666672f;
	__Local__3->Parent = __Local__1;
	auto __Local__4 = NewObject<UVerticalBox>(__Local__0, UVerticalBox::StaticClass(), TEXT("VerticalBox_75"), (EObjectFlags)0x00280008);
	...
	auto __Local__6 = NewObject<UVerticalBoxSlot>(__Local__4, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_2"), (EObjectFlags)0x00280008);
	__Local__6->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__6->Parent = __Local__4;
	auto __Local__7 = NewObject<UProgressBar>(__Local__0, UProgressBar::StaticClass(), TEXT("BarraOxigeno"), (EObjectFlags)0x00280008);
	auto& __Local__8 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__7->WidgetStyle.BackgroundImage.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__8 = FLinearColor(0.270833, 0.270833, 0.270833, 0.468000);
	__Local__7->Percent = 0.533333f;
	__Local__7->FillColorAndOpacity = FLinearColor(0.000000, 0.458000, 1.000000, 1.000000);
	__Local__7->Slot = __Local__6;
	__Local__6->Content = __Local__7;
	__Local__5.Add(__Local__6);
	auto __Local__9 = NewObject<UVerticalBoxSlot>(__Local__4, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_1"), (EObjectFlags)0x00280008);
	__Local__9->Size.SizeRule = ESlateSizeRule::Type::Fill;
	__Local__9->Parent = __Local__4;
	auto __Local__10 = NewObject<UProgressBar>(__Local__0, UProgressBar::StaticClass(), TEXT("BarraFiltro"), (EObjectFlags)0x00280008);
	auto& __Local__11 = (*(AccessPrivateProperty<FLinearColor >(&(__Local__10->WidgetStyle.BackgroundImage.TintColor), FSlateColor::__PPO__SpecifiedColor() )));
	__Local__11 = FLinearColor(0.270833, 0.270833, 0.270833, 0.468000);
	__Local__10->Percent = 0.533333f;
	__Local__10->FillColorAndOpacity = FLinearColor(0.299910, 1.000000, 0.453828, 1.000000);
...
PRAGMA_ENABLE_OPTIMIZATION
void UAhogamiento_C__pf2402407856::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__12;
	SlotNames.Append(__Local__12);
}
void UAhogamiento_C__pf2402407856::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__13;
	TArray<FDelegateRuntimeBinding>  __Local__14;
	__Local__14.AddUninitialized(2);
	FDelegateRuntimeBinding::StaticStruct()->InitializeStruct(__Local__14.GetData(), 2);
	auto& __Local__15 = __Local__14[0];
	__Local__15.ObjectName = FString(TEXT("BarraOxigeno"));
	__Local__15.PropertyName = FName(TEXT("Percent"));
	auto& __Local__16 = (*(AccessPrivateProperty<TArray<FPropertyPathSegment> >(&(__Local__15.SourcePath), FCachedPropertyPath::__PPO__Segments() )));
	...
	__Local__17.Name = FName(TEXT("NivelDeOxigeno"));
	__Local__15.Kind = EBindingKind::Property;
	auto& __Local__18 = __Local__14[1];
	__Local__18.ObjectName = FString(TEXT("BarraFiltro"));
	...
	__Local__20.Name = FName(TEXT("NivelDeFiltro"));
	__Local__18.Kind = EBindingKind::Property;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, true, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UAhogamiento_C__pf2402407856::StaticClass())->MiscConvertedSubobjects[0]), __Local__13, __Local__14);
}
void UAhogamiento_C__pf2402407856::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UAhogamiento_C__pf2402407856::bpf__ExecuteUbergraph_Ahogamiento__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_LessEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::LessEqual_FloatFloat(bpv__NivelDeOxigeno__pf, 0.000000);
		...
		case 5:
			{
				bpv__bEstaVivo__pf = false;
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				bpfv__CallFunc_GreaterEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_FloatFloat(bpv__NivelDeOxigeno__pf, 1.000000);
		...
		case 11:
			{
				bpfv__CallFunc_GreaterEqual_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::GreaterEqual_FloatFloat(bpv__NivelDeFiltro__pf, 0.000000);
		...
		case 12:
			{
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_3__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__DevanecimientoDeFiltro__pf, b0l__K2Node_Event_InDeltaTime__pf);
				bpfv__CallFunc_Subtract_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__NivelDeFiltro__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_3__pf);
				bpv__NivelDeFiltro__pf = bpfv__CallFunc_Subtract_FloatFloat_ReturnValue_1__pf;
			}
		case 13:
			{
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__RecuperacionOxigeno__pf, b0l__K2Node_Event_InDeltaTime__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Add_FloatFloat(bpv__NivelDeOxigeno__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_2__pf);
				...
				bpv__NivelDeOxigeno__pf = bpfv__CallFunc_FClamp_ReturnValue_1__pf;
				__CurrentState = -1;
				break;
			}
		case 14:
			{
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_1__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__RecuperacionOxigeno__pf, b0l__K2Node_Event_InDeltaTime__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__NivelDeOxigeno__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_1__pf);
				...
				bpv__NivelDeOxigeno__pf = bpfv__CallFunc_FClamp_ReturnValue__pf;
				__CurrentState = 6;
				break;
			}
		case 15:
			{
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(bpv__DesvanecimientoDeOxigeno__pf, b0l__K2Node_Event_InDeltaTime__pf);
				bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpv__NivelDeOxigeno__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf);
				bpv__NivelDeOxigeno__pf = bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf;
				__CurrentState = 1;
				break;
			}
		default:
...
void UAhogamiento_C__pf2402407856::bpf__ExecuteUbergraph_Ahogamiento__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 16);
	// optimized KCST_UnconditionalGoto
	bpv__bAhogandose__pf = true;
	return; // KCST_GotoReturn
}
void UAhogamiento_C__pf2402407856::bpf__ExecuteUbergraph_Ahogamiento__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UAhogamiento_C__pf2402407856::bpf__DejarDeAgotar__pf()
{
	bpf__ExecuteUbergraph_Ahogamiento__pf_2(18);
}
void UAhogamiento_C__pf2402407856::bpf__EmpezarAAgotar__pf()
{
	bpf__ExecuteUbergraph_Ahogamiento__pf_1(16);
}
void UAhogamiento_C__pf2402407856::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b0l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b0l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_Ahogamiento__pf_0(8);
}
PRAGMA_DISABLE_OPTIMIZATION
void UAhogamiento_C__pf2402407856::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UAhogamiento_C__pf2402407856::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{96, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/SlateCore.Geometry 
		...
		{97, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.ProgressBar 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UAhogamiento_C__pf2402407856
{
	FRegisterHelper__UAhogamiento_C__pf2402407856()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/HUD/Ahogamiento"), &UAhogamiento_C__pf2402407856::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UAhogamiento_C__pf2402407856 Instance;
};
FRegisterHelper__UAhogamiento_C__pf2402407856 FRegisterHelper__UAhogamiento_C__pf2402407856::Instance;
