...
APanel_BP_C__pf479927698::APanel_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APanel_BP_C__pf479927698::StaticClass() == GetClass()))
	{
		APanel_BP_C__pf479927698::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__Panel_mesh__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Panel_mesh"));
	bpv__Panel_collision__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("Panel_collision"));
	bpv__Panel_light_G__pf = CreateDefaultSubobject<URectLightComponent>(TEXT("Panel_light_G"));
	bpv__Panel_light_R__pf = CreateDefaultSubobject<URectLightComponent>(TEXT("Panel_light_R"));
	RootComponent = bpv__Panel_mesh__pf;
	bpv__Panel_mesh__pf->CreationMethod = EComponentCreationMethod::Native;
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Panel_mesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APanel_BP_C__pf479927698::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Panel_mesh__pf->BodyInstance.bEnableGravity = false;
	bpv__Panel_mesh__pf->RelativeScale3D = FVector(0.500000, 0.500000, 0.031250);
	...
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Panel_mesh__pf), true, 0));
	bpv__Panel_collision__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Panel_collision__pf->AttachToComponent(bpv__Panel_mesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Panel_collision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	bpv__Panel_collision__pf->RelativeLocation = FVector(2.000000, -0.000000, 63.999939);
	bpv__Panel_collision__pf->RelativeScale3D = FVector(1.531250, 1.500000, 5.656250);
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Panel_collision__pf), true, 0));
	bpv__Panel_light_G__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Panel_light_G__pf->AttachToComponent(bpv__Panel_mesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Panel_light_G__pf->LightColor = FColor(177, 255, 175, 255);
	bpv__Panel_light_G__pf->RelativeLocation = FVector(-0.000003, 0.000000, 479.999939);
	bpv__Panel_light_G__pf->RelativeRotation = FRotator(-89.999992, 0.018100, -0.018127);
	bpv__Panel_light_G__pf->bVisible = false;
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Panel_light_G__pf), false, 0));
	bpv__Panel_light_R__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Panel_light_R__pf->AttachToComponent(bpv__Panel_mesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Panel_light_R__pf->LightColor = FColor(255, 89, 88, 255);
	bpv__Panel_light_R__pf->RelativeLocation = FVector(-0.000003, 0.000000, 479.999939);
	bpv__Panel_light_R__pf->RelativeRotation = FRotator(-89.999992, 0.018100, -0.018127);
	bpv__Panel_light_R__pf->bVisible = false;
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Panel_light_R__pf), false, 0));
	bpv__Ligth_status__pf = false;
	bpv__Correct__pf = false;
	bpv__NumeroDePanel__pf = 0;
	bpv__SeHaAnadido__pf = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void APanel_BP_C__pf479927698::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__Panel_mesh__pf)
	{
		bpv__Panel_mesh__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Panel_collision__pf)
	{
		bpv__Panel_collision__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Panel_light_G__pf)
	{
		bpv__Panel_light_G__pf->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Panel_light_R__pf)
	{
		bpv__Panel_light_R__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void APanel_BP_C__pf479927698::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__7.ComponentPropertyName = FName(TEXT("Panel_collision"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APanel_BP_C__pf479927698::bpf__ExecuteUbergraph_Panel_BP__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 8);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__Panel_light_R__pf))
	{
		bpv__Panel_light_R__pf->USceneComponent::SetVisibility(false, false);
	}
	if(::IsValid(bpv__Panel_light_G__pf))
	{
		bpv__Panel_light_G__pf->USceneComponent::SetVisibility(false, false);
	}
	return; // KCST_GotoReturn
}
void APanel_BP_C__pf479927698::bpf__ExecuteUbergraph_Panel_BP__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				bpf__Ligth_controller__pf(bpv__Panel_light_R__pf);
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				bpf__Ligth_controller__pf(bpv__Panel_light_G__pf);
				__CurrentState = -1;
				break;
			}
		default:
...
void APanel_BP_C__pf479927698::bpf__LightControllerEvent__pf()
{
	bpf__ExecuteUbergraph_Panel_BP__pf_0(8);
}
void APanel_BP_C__pf479927698::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	typedef FHitResult  T__Local__8;
	T__Local__8& bpp__SweepResult__pf = *const_cast<T__Local__8 *>(&bpp__SweepResult__pf__const);
	...
	bpf__ExecuteUbergraph_Panel_BP__pf_1(1);
}
void APanel_BP_C__pf479927698::bpf__Ligth_controller__pf(ULightComponent* bpp__ligth__pf)
{
	...
	do
	{
		...
		case 2:
			{
				if(::IsValid(bpp__ligth__pf))
				{
					bpp__ligth__pf->USceneComponent::ToggleVisibility(false);
				}
			}
		case 3:
			{
...
PRAGMA_DISABLE_OPTIMIZATION
void APanel_BP_C__pf479927698::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APanel_BP_C__pf479927698::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{124, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.RectLightComponent 
		...
		{190, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.LightComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APanel_BP_C__pf479927698
{
	FRegisterHelper__APanel_BP_C__pf479927698()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/GameplayMechanics/Panel_bp"), &APanel_BP_C__pf479927698::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APanel_BP_C__pf479927698 Instance;
};
FRegisterHelper__APanel_BP_C__pf479927698 FRegisterHelper__APanel_BP_C__pf479927698::Instance;
