...
ASalida_BP_C__pf479927698::ASalida_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ASalida_BP_C__pf479927698::StaticClass() == GetClass()))
	{
		ASalida_BP_C__pf479927698::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	if(__Local__1)
	{
		...
		__Local__1->RelativeLocation = FVector(0.000000, 0.000000, 48.204353);
		__Local__1->RelativeScale3D = FVector(2.792300, 2.792300, 1.000000);
	...
	if(__Local__3)
	{
		...
		__Local__15 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__3->RelativeScale3D = FVector(1.000000, 1.000000, 0.209531);
	...
	if(__Local__4)
	{
		...
		auto& __Local__19 = (*(AccessPrivateProperty<UStaticMesh* >((__Local__4), UStaticMeshComponent::__PPO__StaticMesh() )));
		__Local__19 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
		...
		__Local__4->RelativeLocation = FVector(34.088364, -32.507805, 11.054855);
		__Local__4->RelativeScale3D = FVector(0.074991, 0.074991, 0.074991);
	...
	if(__Local__5)
	{
		...
		__Local__23 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
		auto& __Local__24 = (*(AccessPrivateProperty<UStaticMeshComponent*>((__Local__5), USceneComponent::__PPO__AttachParent() )));
		__Local__24 = __Local__0;
		__Local__5->RelativeLocation = FVector(9.773214, 44.298168, 11.054855);
		__Local__5->RelativeScale3D = FVector(0.074991, 0.074991, 0.074991);
		...
		(((UBoolProperty*)__Local__25)->SetPropertyValue_InContainer((__Local__5), true, 0));
		// --- END default subobject 'Mesh3' //
	}
	if(__Local__6)
	{
		// --- Default subobject 'Mesh4' //
		auto& __Local__27 = (*(AccessPrivateProperty<UStaticMesh* >((__Local__6), UStaticMeshComponent::__PPO__StaticMesh() )));
		__Local__27 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
		auto& __Local__28 = (*(AccessPrivateProperty<UStaticMeshComponent*>((__Local__6), USceneComponent::__PPO__AttachParent() )));
		__Local__28 = __Local__0;
		__Local__6->RelativeLocation = FVector(-45.389568, -14.056007, 11.054855);
		__Local__6->RelativeScale3D = FVector(0.074991, 0.074991, 0.074991);
		...
		(((UBoolProperty*)__Local__29)->SetPropertyValue_InContainer((__Local__6), true, 0));
...
void ASalida_BP_C__pf479927698::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ASalida_BP_C__pf479927698::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((UBoolProperty*)__Local__32)->SetPropertyValue_InContainer((__Local__31), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void ASalida_BP_C__pf479927698::bpf__ExecuteUbergraph_Salida_BP__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				...
				b0l__K2Node_DynamicCast_AsIsolation_UE4Character__pf = Cast<AIsolationUE4Character>(bpfv__CallFunc_GetPlayerPawn_ReturnValue__pf);
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsIsolation_UE4Character__pf != nullptr);;
		...
		case 2:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsIsolation_UE4Character__pf))
				{
					b0l__K2Node_DynamicCast_AsIsolation_UE4Character__pf->bOnAnimation = true;
				}
			}
		case 3:
			{
				UUserWidget*  __Local__34 = ((UUserWidget*)nullptr);
				b0l__K2Node_DynamicCast_AsAhogamiento__pf = Cast<UAhogamiento_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->Ahogamiento) : (__Local__34)));
				b0l__K2Node_DynamicCast_bSuccess_5__pf = (b0l__K2Node_DynamicCast_AsAhogamiento__pf != nullptr);;
		...
		case 4:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsAhogamiento__pf->SetVisibility(ESlateVisibility::Hidden);
				}
			}
		case 5:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsAhogamiento__pf))
				{
					b0l__K2Node_DynamicCast_AsAhogamiento__pf->bpv__NivelDeOxigeno__pf = 1.000000;
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 14:
			{
				...
				b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf = Cast<ATopDownCharacter_C__pf1773622777>(bpfv__CallFunc_GetPlayerPawn_ReturnValue_2__pf);
		...
		case 15:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf != nullptr);;
		...
		case 16:
			{
				int32  __Local__35 = 0;
				int32  __Local__36 = 0;
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf->bpv__LlavesAmarillas__pf) : (__Local__35)), ((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf->bpv__LlavesRojas__pf) : (__Local__36)));
				int32  __Local__37 = 0;
				bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Add_IntInt(bpfv__CallFunc_Add_IntInt_ReturnValue__pf, ((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf->bpv__LlavesVerdes__pf) : (__Local__37)));
				bpfv__CallFunc_LessEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::LessEqual_IntInt(bpfv__CallFunc_Add_IntInt_ReturnValue_1__pf, 1);
		...
		case 17:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->bpf__AparecerMensaje__pf(FString(TEXT("¡Te faltan llaves!")));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 18:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf))
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->bpf__AparecerMensaje__pf(FString(TEXT("¡Te falta una llave!")));
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		...
		case 26:
			{
				...
				b0l__K2Node_DynamicCast_AsTop_Down_Character__pf = Cast<ATopDownCharacter_C__pf1773622777>(bpfv__CallFunc_GetPlayerPawn_ReturnValue_1__pf);
		...
		case 28:
			{
				int32  __Local__38 = 0;
				bpfv__CallFunc_Greater_IntInt_ReturnValue_2__pf = UKismetMathLibrary::Greater_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__LlavesAmarillas__pf) : (__Local__38)), 0);
		...
		case 29:
			{
				int32  __Local__39 = 0;
				bpfv__CallFunc_Greater_IntInt_ReturnValue_1__pf = UKismetMathLibrary::Greater_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__LlavesRojas__pf) : (__Local__39)), 0);
		...
		case 30:
			{
				int32  __Local__40 = 0;
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__LlavesVerdes__pf) : (__Local__40)), 0);
		...
		case 31:
			{
				UKismetSystemLibrary::PrintString(this, FString(TEXT("GANASTE")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 2.000000);
			}
		case 32:
			{
		...
		case 33:
			{
				UUserWidget*  __Local__41 = ((UUserWidget*)nullptr);
				b0l__K2Node_DynamicCast_AsInicio_Final_WB__pf = Cast<UInicioFinalWB_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->InicioFinal) : (__Local__41)));
				b0l__K2Node_DynamicCast_bSuccess_6__pf = (b0l__K2Node_DynamicCast_AsInicio_Final_WB__pf != nullptr);;
		...
		case 34:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsInicio_Final_WB__pf->bpf__Final__pf();
				}
				__CurrentState = 1;
				break;
			}
...
void ASalida_BP_C__pf479927698::bpf__ExecuteUbergraph_Salida_BP__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 20);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(Mesh2))
	{
		Mesh2->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	}
	if(::IsValid(Mesh3))
	{
		Mesh3->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
	}
	if(::IsValid(Mesh4))
	{
		Mesh4->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	}
	if(::IsValid(Mesh1))
	{
		Mesh1->SetMaterial(0, CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASalida_BP_C__pf479927698::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
	}
	return; //KCST_EndOfThread
}
void ASalida_BP_C__pf479927698::bpf__InteraccionBlueprint__pf()
{
	bpf__ExecuteUbergraph_Salida_BP__pf_0(25);
}
void ASalida_BP_C__pf479927698::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Salida_BP__pf_1(20);
}
PRAGMA_DISABLE_OPTIMIZATION
void ASalida_BP_C__pf479927698::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ASalida_BP_C__pf479927698::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ASalida_BP_C__pf479927698
{
	FRegisterHelper__ASalida_BP_C__pf479927698()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/GameplayMechanics/Salida_BP"), &ASalida_BP_C__pf479927698::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ASalida_BP_C__pf479927698 Instance;
};
FRegisterHelper__ASalida_BP_C__pf479927698 FRegisterHelper__ASalida_BP_C__pf479927698::Instance;
