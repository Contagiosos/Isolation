...
#include "Nivel_SalaAlmacenaje00__pf626307183.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/TopDownCPP/Niveles/Nivel_SalaAlmacenaje00.Nivel_SalaAlmacenaje00_C", OverrideNativeName="Nivel_SalaAlmacenaje00_C"))
class ANivel_SalaAlmacenaje00_C__pf626307183 : public ANivel
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LargueBox"))
	UStaticMeshComponent* bpv__LargueBox__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Barril3"))
	UStaticMeshComponent* bpv__Barril3__pf;
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Barril2"))
	UStaticMeshComponent* bpv__Barril2__pf;
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Barril"))
	UStaticMeshComponent* bpv__Barril__pf;
	...
	ANivel_SalaAlmacenaje00_C__pf626307183(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_4(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Nivel_SalaAlmacenaje00_5"))
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_7(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_8(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_SalaAlmacenaje00__pf_9(int32 bpp__EntryPoint__pf);
