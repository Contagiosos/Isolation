...
#include "IsolationGameInstance__pf1773622777.h"
...
UIsolationGameInstance_C__pf1773622777::UIsolationGameInstance_C__pf1773622777(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UIsolationGameInstance_C__pf1773622777::StaticClass() == GetClass()))
	{
		UIsolationGameInstance_C__pf1773622777::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__MainMenuWB__pf = nullptr;
}
PRAGMA_ENABLE_OPTIMIZATION
void UIsolationGameInstance_C__pf1773622777::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UIsolationGameInstance_C__pf1773622777::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UStartMenu_C__pf2402407856::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void UIsolationGameInstance_C__pf1773622777::bpf__ExecuteUbergraph_IsolationGameInstance__pf_0(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_IsValid_ReturnValue__pf{};
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	UStartMenu_C__pf2402407856* bpfv__CallFunc_Create_ReturnValue__pf{};
	...
	do
	{
		...
		case 2:
			{
				...
				UWidgetBlueprintLibrary::SetInputMode_UIOnlyEx(bpfv__CallFunc_GetPlayerController_ReturnValue__pf, bpv__MainMenuWB__pf, EMouseLockMode::DoNotLock);
			}
		case 3:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
		...
		case 6:
			{
				bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
				bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UStartMenu_C__pf2402407856>(UWidgetBlueprintLibrary::Create(this, UStartMenu_C__pf2402407856::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 7:
			{
...
void UIsolationGameInstance_C__pf1773622777::bpf__ShowMainMenu__pf()
{
	bpf__ExecuteUbergraph_IsolationGameInstance__pf_0(4);
}
PRAGMA_DISABLE_OPTIMIZATION
void UIsolationGameInstance_C__pf1773622777::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UIsolationGameInstance_C__pf1773622777::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{161, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.GameInstance 
		...
		{162, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/TopDownCPP/HUD/StartMenu.StartMenu_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UIsolationGameInstance_C__pf1773622777
{
	FRegisterHelper__UIsolationGameInstance_C__pf1773622777()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/Blueprints/IsolationGameInstance"), &UIsolationGameInstance_C__pf1773622777::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UIsolationGameInstance_C__pf1773622777 Instance;
};
FRegisterHelper__UIsolationGameInstance_C__pf1773622777 FRegisterHelper__UIsolationGameInstance_C__pf1773622777::Instance;
