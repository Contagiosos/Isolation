...
#include "PruebaCambioDeSala__pf1773622777.h"
...
APruebaCambioDeSala_C__pf1773622777::APruebaCambioDeSala_C__pf1773622777(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APruebaCambioDeSala_C__pf1773622777::StaticClass() == GetClass()))
	{
		APruebaCambioDeSala_C__pf1773622777::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APruebaCambioDeSala_C__pf1773622777::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->SetCollisionProfileName(FName(TEXT("OverlapAll")));
	bpv__StaticMesh__pf->RelativeScale3D = FVector(0.500000, 0.750000, 1.500000);
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), true, 0));
	bpv__Posicion__pf = 0;
}
PRAGMA_ENABLE_OPTIMIZATION
void APruebaCambioDeSala_C__pf1773622777::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APruebaCambioDeSala_C__pf1773622777::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APruebaCambioDeSala_C__pf1773622777::bpf__ExecuteUbergraph_PruebaCambioDeSala__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->PosicionActualIndex = bpv__Posicion__pf;
	}
	UUserWidget*  __Local__5 = ((UUserWidget*)nullptr);
	b0l__K2Node_DynamicCast_AsHUDOverlay__pf = Cast<UHUDOverlay_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->HUDOverlay) : (__Local__5)));
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsHUDOverlay__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_2__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsHUDOverlay__pf))
	{
		b0l__K2Node_DynamicCast_AsHUDOverlay__pf->bpf__EnNuevaPosicion__pf(bpv__Posicion__pf);
	}
	return; // KCST_GotoReturn
}
void APruebaCambioDeSala_C__pf1773622777::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_PruebaCambioDeSala__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void APruebaCambioDeSala_C__pf1773622777::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APruebaCambioDeSala_C__pf1773622777::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APruebaCambioDeSala_C__pf1773622777
{
	FRegisterHelper__APruebaCambioDeSala_C__pf1773622777()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/Blueprints/PruebaCambioDeSala"), &APruebaCambioDeSala_C__pf1773622777::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APruebaCambioDeSala_C__pf1773622777 Instance;
};
FRegisterHelper__APruebaCambioDeSala_C__pf1773622777 FRegisterHelper__APruebaCambioDeSala_C__pf1773622777::Instance;
