...
#include "LockerGreen_BP__pf479927698.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/TopDownCPP/GameplayMechanics/LockerGreen_BP.LockerGreen_BP_C", OverrideNativeName="LockerGreen_BP_C"))
class ALockerGreen_BP_C__pf479927698 : public AInteractuable
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(meta=(OverrideNativeName="Rotar_NewTrack_0_4CE48F89444A315DBFF447ADDF81C515"))
	float bpv__Rotar_NewTrack_0_4CE48F89444A315DBFF447ADDF81C515__pf;
	UPROPERTY(meta=(OverrideNativeName="Rotar__Direction_4CE48F89444A315DBFF447ADDF81C515"))
	TEnumAsByte<ETimelineDirection::Type> bpv__Rotar__Direction_4CE48F89444A315DBFF447ADDF81C515__pf;
	UPROPERTY(BlueprintReadWrite, meta=(Category="LockerGreen_BP", OverrideNativeName="Rotar"))
	...
	ALockerGreen_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_LockerGreen_BP__pf_7(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(CppFromBpEvent, OverrideNativeName="InteraccionBlueprint"))
	virtual void bpf__InteraccionBlueprint__pf();
	UFUNCTION(BlueprintCallable, meta=(CallInEditor="true", Category, OverrideNativeName="OnCompleted_31E637E94C7922F2099CAFB4AE368123"))
	virtual void bpf__OnCompleted_31E637E94C7922F2099CAFB4AE368123__pf(FName bpp__NotifyName__pf);
	UFUNCTION(BlueprintCallable, meta=(CallInEditor="true", Category, OverrideNativeName="OnBlendOut_31E637E94C7922F2099CAFB4AE368123"))
	virtual void bpf__OnBlendOut_31E637E94C7922F2099CAFB4AE368123__pf(FName bpp__NotifyName__pf);
	UFUNCTION(BlueprintCallable, meta=(CallInEditor="true", Category, OverrideNativeName="OnInterrupted_31E637E94C7922F2099CAFB4AE368123"))
	virtual void bpf__OnInterrupted_31E637E94C7922F2099CAFB4AE368123__pf(FName bpp__NotifyName__pf);
	UFUNCTION(BlueprintCallable, meta=(CallInEditor="true", Category, OverrideNativeName="OnNotifyBegin_31E637E94C7922F2099CAFB4AE368123"))
	virtual void bpf__OnNotifyBegin_31E637E94C7922F2099CAFB4AE368123__pf(FName bpp__NotifyName__pf);
	UFUNCTION(BlueprintCallable, meta=(CallInEditor="true", Category, OverrideNativeName="OnNotifyEnd_31E637E94C7922F2099CAFB4AE368123"))
	virtual void bpf__OnNotifyEnd_31E637E94C7922F2099CAFB4AE368123__pf(FName bpp__NotifyName__pf);
