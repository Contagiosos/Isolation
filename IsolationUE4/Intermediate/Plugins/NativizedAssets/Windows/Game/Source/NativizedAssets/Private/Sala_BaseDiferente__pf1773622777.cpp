...
#include "Sala_BaseDiferente__pf1773622777.h"
...
ASala_BaseDiferente_C__pf1773622777::ASala_BaseDiferente_C__pf1773622777(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ASala_BaseDiferente_C__pf1773622777::StaticClass() == GetClass()))
	{
		ASala_BaseDiferente_C__pf1773622777::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__PuertaArriba__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__PuertaArriba__pf->OverrideMaterials.Reserve(1);
	bpv__PuertaArriba__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	__Local__4 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__PuertaDerecha__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__PuertaDerecha__pf->OverrideMaterials.Reserve(1);
	bpv__PuertaDerecha__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	__Local__5 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__PuertaAbajo__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__PuertaAbajo__pf->OverrideMaterials.Reserve(1);
	bpv__PuertaAbajo__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	__Local__6 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__PuertaIzquierda__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__PuertaIzquierda__pf->OverrideMaterials.Reserve(1);
	bpv__PuertaIzquierda__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	...
	bpv__StaticMesh__pf->AttachToComponent(bpv__Escenario__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__7 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__StaticMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__7 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ASala_BaseDiferente_C__pf1773622777::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->RelativeLocation = FVector(91.056778, 13.180389, 212.291992);
	bpv__StaticMesh__pf->RelativeScale3D = FVector(0.404148, 0.404148, 0.404148);
...
void ASala_BaseDiferente_C__pf1773622777::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ASala_BaseDiferente_C__pf1773622777::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((UBoolProperty*)__Local__10)->SetPropertyValue_InContainer((__Local__8), false, 0));
	__Local__9->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__9->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__9->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__12 = __Local__9->ComponentDelegateBindings[0];
...
PRAGMA_ENABLE_OPTIMIZATION
void ASala_BaseDiferente_C__pf1773622777::bpf__ExecuteUbergraph_Sala_BaseDiferente__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ASala_BaseDiferente_C__pf1773622777::bpf__ExecuteUbergraph_Sala_BaseDiferente__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	UUserWidget*  __Local__13 = ((UUserWidget*)nullptr);
	b0l__K2Node_DynamicCast_AsMap__pf = Cast<UMap_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->MapWidget) : (__Local__13)));
...
void ASala_BaseDiferente_C__pf1773622777::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Sala_BaseDiferente__pf_1(22);
}
void ASala_BaseDiferente_C__pf1773622777::bpf__UpdateDoors__pf()
{
	bpf__ExecuteUbergraph_Sala_BaseDiferente__pf_0(16);
}
PRAGMA_DISABLE_OPTIMIZATION
void ASala_BaseDiferente_C__pf1773622777::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ASala_BaseDiferente_C__pf1773622777::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ASala_BaseDiferente_C__pf1773622777
{
	FRegisterHelper__ASala_BaseDiferente_C__pf1773622777()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/Blueprints/Sala_BaseDiferente"), &ASala_BaseDiferente_C__pf1773622777::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ASala_BaseDiferente_C__pf1773622777 Instance;
};
FRegisterHelper__ASala_BaseDiferente_C__pf1773622777 FRegisterHelper__ASala_BaseDiferente_C__pf1773622777::Instance;
