...
AInteractuablePrueba_BP_C__pf479927698::AInteractuablePrueba_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AInteractuablePrueba_BP_C__pf479927698::StaticClass() == GetClass()))
	{
		AInteractuablePrueba_BP_C__pf479927698::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	if(__Local__0)
	{
		...
		__Local__7 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AInteractuablePrueba_BP_C__pf479927698::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	if(__Local__1)
	{
		...
		__Local__1->RelativeScale3D = FVector(2.500000, 2.500000, 2.500000);
...
void AInteractuablePrueba_BP_C__pf479927698::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AInteractuablePrueba_BP_C__pf479927698::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AInteractuablePrueba_BP_C__pf479927698::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AInteractuablePrueba_BP_C__pf479927698::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AInteractuablePrueba_BP_C__pf479927698
{
	FRegisterHelper__AInteractuablePrueba_BP_C__pf479927698()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/GameplayMechanics/InteractuablePrueba_BP"), &AInteractuablePrueba_BP_C__pf479927698::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AInteractuablePrueba_BP_C__pf479927698 Instance;
};
FRegisterHelper__AInteractuablePrueba_BP_C__pf479927698 FRegisterHelper__AInteractuablePrueba_BP_C__pf479927698::Instance;
