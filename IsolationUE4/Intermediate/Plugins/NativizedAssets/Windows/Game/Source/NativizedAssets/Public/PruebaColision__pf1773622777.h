...
#include "PruebaColision__pf1773622777.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/TopDownCPP/Blueprints/PruebaColision.PruebaColision_C", OverrideNativeName="PruebaColision_C"))
class APruebaColision_C__pf1773622777 : public AActor
{
public:
	GENERATED_BODY()
	...
	APruebaColision_C__pf1773622777(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_PruebaColision_0"))
	void bpf__ExecuteUbergraph_PruebaColision__pf_0(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_PruebaColision_1"))
	void bpf__ExecuteUbergraph_PruebaColision__pf_1(int32 bpp__EntryPoint__pf);
