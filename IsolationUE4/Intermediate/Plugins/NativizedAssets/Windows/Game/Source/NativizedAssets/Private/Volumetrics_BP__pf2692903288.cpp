...
AVolumetrics_BP_C__pf2692903288::AVolumetrics_BP_C__pf2692903288(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AVolumetrics_BP_C__pf2692903288::StaticClass() == GetClass()))
	{
		AVolumetrics_BP_C__pf2692903288::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Plane__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Plane"));
	...
	bpv__Plane__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Plane__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AVolumetrics_BP_C__pf2692903288::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Plane__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Plane__pf->OverrideMaterials.Reserve(1);
	bpv__Plane__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AVolumetrics_BP_C__pf2692903288::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Plane__pf->SetCollisionProfileName(FName(TEXT("OverlapAll")));
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Plane__pf), true, 0));
	bpv__Expandir_Expansion_BC3A1DC44CAD4EC2B901C99009150564__pf = 0.000000f;
	bpv__Expandir__Direction_BC3A1DC44CAD4EC2B901C99009150564__pf = ETimelineDirection::Type::Forward;
	bpv__Expandir__pf = nullptr;
	bpv__VolumeHeight__pf = 50.000000f;
	bpv__VolumeResolution__pf = 30;
	bpv__PreviusLayerHeight__pf = 0.000000f;
	bpv__SeedHeight__pf = 0.000000f;
}
PRAGMA_ENABLE_OPTIMIZATION
void AVolumetrics_BP_C__pf2692903288::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AVolumetrics_BP_C__pf2692903288::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__4 = NewObject<UTimelineTemplate>(InDynamicClass, UTimelineTemplate::StaticClass(), TEXT("Expandir_Template"), (EObjectFlags)0x00280008);
	...
	auto& __Local__6 = (*(AccessPrivateProperty<UStaticMesh* >((__Local__3), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__6 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AVolumetrics_BP_C__pf2692903288::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	__Local__3->OverrideMaterials = TArray<UMaterialInterface*> ();
	__Local__3->OverrideMaterials.Reserve(1);
	__Local__3->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AVolumetrics_BP_C__pf2692903288::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__7 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(__Local__3->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__7 = ECollisionChannel::ECC_WorldStatic;
	auto& __Local__8 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(__Local__3->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__8 = ECollisionEnabled::Type::NoCollision;
	auto& __Local__9 = (*(AccessPrivateProperty<FName >(&(__Local__3->BodyInstance), FBodyInstance::__PPO__CollisionProfileName() )));
	__Local__9 = FName(TEXT("NoCollision"));
	auto& __Local__10 = (*(AccessPrivateProperty<FCollisionResponse >(&(__Local__3->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__11.GetData(), 2);
	...
	auto& __Local__13 = __Local__11[1];
	...
	(((UBoolProperty*)__Local__14)->SetPropertyValue_InContainer((__Local__3), true, 0));
	__Local__4->TimelineLength = 1500.000000f;
	...
	__Local__19.Time = 1500.000000f;
	__Local__19.Value = 400.000000f;
	...
	__Local__26.ComponentPropertyName = FName(TEXT("Plane"));
	__Local__26.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__26.FunctionNameToBind = FName(TEXT("BndEvt__Plane_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__27 = __Local__5->ComponentDelegateBindings[1];
	__Local__27.ComponentPropertyName = FName(TEXT("Plane"));
	__Local__27.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__27.FunctionNameToBind = FName(TEXT("BndEvt__Plane_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AVolumetrics_BP_C__pf2692903288::bpf__ExecuteUbergraph_Volumetrics_BP__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsAhogamiento__pf = Cast<UAhogamiento_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->Ahogamiento) : (__Local__28)));
	b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsAhogamiento__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsAhogamiento__pf->bpf__DejarDeAgotar__pf();
	}
	return; //KCST_EndOfThread
}
void AVolumetrics_BP_C__pf2692903288::bpf__ExecuteUbergraph_Volumetrics_BP__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 26:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->bpf__ShowAhogamiento__pf();
				}
			}
		case 27:
			{
				UUserWidget*  __Local__29 = ((UUserWidget*)nullptr);
				b0l__K2Node_DynamicCast_AsAhogamiento_1__pf = Cast<UAhogamiento_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->Ahogamiento) : (__Local__29)));
				b0l__K2Node_DynamicCast_bSuccess_4__pf = (b0l__K2Node_DynamicCast_AsAhogamiento_1__pf != nullptr);;
		...
		case 28:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsAhogamiento_1__pf))
				{
					b0l__K2Node_DynamicCast_AsAhogamiento_1__pf->bpf__EmpezarAAgotar__pf();
				}
				__CurrentState = -1;
				break;
			}
		case 29:
			{
				b0l__K2Node_DynamicCast_AsNivel__pf = Cast<ANivel>(b0l__K2Node_ComponentBoundEvent_OtherActor_1__pf);
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsNivel__pf != nullptr);;
		...
		case 30:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsNivel__pf))
				{
					b0l__K2Node_DynamicCast_AsNivel__pf->bPuedeVerElGas = true;
				}
				__CurrentState = -1;
				break;
			}
...
void AVolumetrics_BP_C__pf2692903288::bpf__ExecuteUbergraph_Volumetrics_BP__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 6:
			{
				if(::IsValid(bpv__Expandir__pf))
				{
					bpv__Expandir__pf->UTimelineComponent::Play();
				}
		...
		case 8:
			{
				bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf = UKismetMathLibrary::Conv_IntToFloat(bpv__VolumeResolution__pf);
				bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(bpv__VolumeHeight__pf, bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__PreviusLayerHeight__pf, bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf);
				...
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(bpfv__CallFunc_MakeVector_ReturnValue_1__pf, FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_AddComponent_ReturnValue__pf = CastChecked<UStaticMeshComponent>(AActor::AddComponent(FName(TEXT("NODE_AddStaticMeshComponent-0")), false, bpfv__CallFunc_MakeTransform_ReturnValue__pf, this), ECastCheckedType::NullAllowed);
			}
		case 9:
			{
				bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf = UKismetMathLibrary::Conv_IntToFloat(bpv__VolumeResolution__pf);
				bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(bpv__VolumeHeight__pf, bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf);
				bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Add_FloatFloat(bpv__PreviusLayerHeight__pf, bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf);
				bpv__PreviusLayerHeight__pf = bpfv__CallFunc_Add_FloatFloat_ReturnValue__pf;
			}
		case 10:
			{
				if(::IsValid(bpfv__CallFunc_AddComponent_ReturnValue__pf))
				{
					bpfv__CallFunc_GetMaterial_ReturnValue_1__pf = bpfv__CallFunc_AddComponent_ReturnValue__pf->GetMaterial(0);
				}
				if(::IsValid(bpfv__CallFunc_AddComponent_ReturnValue__pf))
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue_1__pf = bpfv__CallFunc_AddComponent_ReturnValue__pf->CreateDynamicMaterialInstance(0, bpfv__CallFunc_GetMaterial_ReturnValue_1__pf, FName(TEXT("None")));
				}
			}
		case 11:
			{
				...
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue_1__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("MinFrom_BP")), bpv__SeedHeight__pf);
				}
			}
		case 12:
			{
				if(::IsValid(bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue_1__pf))
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue_1__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("MaxFrom_BP")), bpv__VolumeHeight__pf);
				}
				__CurrentState = 6;
				break;
			}
		...
		case 14:
			{
				bpfv__CallFunc_LessEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::LessEqual_IntInt(b0l__Temp_int_Variable__pf, bpv__VolumeResolution__pf);
		...
		case 16:
			{
				...
				{
					bpfv__CallFunc_GetMaterial_ReturnValue__pf = bpv__Plane__pf->GetMaterial(0);
				}
				if(::IsValid(bpv__Plane__pf))
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf = bpv__Plane__pf->CreateDynamicMaterialInstance(0, bpfv__CallFunc_GetMaterial_ReturnValue__pf, FName(TEXT("None")));
				}
			}
		case 17:
			{
				if(::IsValid(bpv__Plane__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__Plane__pf->USceneComponent::K2_GetComponentLocation();
				}
				...
				bpv__SeedHeight__pf = b0l__CallFunc_BreakVector_Z__pf;
			}
		case 18:
			{
				if(::IsValid(bpv__Plane__pf))
				...
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("MinFrom_BP")), b0l__CallFunc_BreakVector_Z__pf);
				}
			}
		case 19:
			{
				if(::IsValid(bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf))
				{
					bpfv__CallFunc_CreateDynamicMaterialInstance_ReturnValue__pf->UMaterialInstanceDynamic::SetScalarParameterValue(FName(TEXT("MaxFrom_BP")), bpv__VolumeHeight__pf);
				}
			}
		case 20:
			{
...
void AVolumetrics_BP_C__pf2692903288::bpf__ExecuteUbergraph_Volumetrics_BP__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 21);
	return; //KCST_EndOfThread
}
void AVolumetrics_BP_C__pf2692903288::bpf__ExecuteUbergraph_Volumetrics_BP__pf_4(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_MakeVector_ReturnValue__pf(EForceInit::ForceInit);
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(bpv__Expandir_Expansion_BC3A1DC44CAD4EC2B901C99009150564__pf, bpv__Expandir_Expansion_BC3A1DC44CAD4EC2B901C99009150564__pf, 1.000000);
	AActor::SetActorScale3D(bpfv__CallFunc_MakeVector_ReturnValue__pf);
	return; //KCST_EndOfThread
}
void AVolumetrics_BP_C__pf2692903288::bpf__BndEvt__Plane_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_Volumetrics_BP__pf_0(31);
}
void AVolumetrics_BP_C__pf2692903288::bpf__BndEvt__Plane_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Volumetrics_BP__pf_1(23);
}
void AVolumetrics_BP_C__pf2692903288::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_Volumetrics_BP__pf_2(15);
}
void AVolumetrics_BP_C__pf2692903288::bpf__Expandir__UpdateFunc__pf()
{
	bpf__ExecuteUbergraph_Volumetrics_BP__pf_4(1);
}
void AVolumetrics_BP_C__pf2692903288::bpf__Expandir__FinishedFunc__pf()
{
	bpf__ExecuteUbergraph_Volumetrics_BP__pf_3(21);
}
PRAGMA_DISABLE_OPTIMIZATION
void AVolumetrics_BP_C__pf2692903288::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AVolumetrics_BP_C__pf2692903288::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AVolumetrics_BP_C__pf2692903288
{
	FRegisterHelper__AVolumetrics_BP_C__pf2692903288()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/Effects/VolumetricGas/Volumetrics_BP"), &AVolumetrics_BP_C__pf2692903288::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AVolumetrics_BP_C__pf2692903288 Instance;
};
FRegisterHelper__AVolumetrics_BP_C__pf2692903288 FRegisterHelper__AVolumetrics_BP_C__pf2692903288::Instance;
