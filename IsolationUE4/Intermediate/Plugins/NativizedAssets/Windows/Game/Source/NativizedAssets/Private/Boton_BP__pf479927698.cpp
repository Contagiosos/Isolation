...
#include "Boton_BP__pf479927698.h"
...
ABoton_BP_C__pf479927698::ABoton_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABoton_BP_C__pf479927698::StaticClass() == GetClass()))
	{
		ABoton_BP_C__pf479927698::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	if(__Local__0)
	{
		...
		__Local__7 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoton_BP_C__pf479927698::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	if(__Local__1)
	{
		...
		__Local__1->RelativeLocation = FVector(0.000000, 0.000000, 40.000000);
		__Local__1->RelativeScale3D = FVector(1.500000, 1.500000, 1.000000);
	...
	if(__Local__2)
	{
		...
		__Local__2->RelativeLocation = FVector(0.000000, 0.000000, 150.000000);
...
void ABoton_BP_C__pf479927698::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABoton_BP_C__pf479927698::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	(((UBoolProperty*)__Local__29)->SetPropertyValue_InContainer((__Local__28), false, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABoton_BP_C__pf479927698::bpf__ExecuteUbergraph_Boton_BP__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	UKismetSystemLibrary::PrintString(this, FString(TEXT("Hello")), true, true, FLinearColor(0.000000,0.660000,1.000000,1.000000), 10.000000);
	return; // KCST_GotoReturn
}
void ABoton_BP_C__pf479927698::bpf__InteraccionBlueprint__pf()
{
	bpf__ExecuteUbergraph_Boton_BP__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABoton_BP_C__pf479927698::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{179, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Engine/BasicShapes/Plane.Plane 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABoton_BP_C__pf479927698::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{180, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/IsolationUE4.Boton 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABoton_BP_C__pf479927698
{
	FRegisterHelper__ABoton_BP_C__pf479927698()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/GameplayMechanics/Boton_BP"), &ABoton_BP_C__pf479927698::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABoton_BP_C__pf479927698 Instance;
};
FRegisterHelper__ABoton_BP_C__pf479927698 FRegisterHelper__ABoton_BP_C__pf479927698::Instance;
