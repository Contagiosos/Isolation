...
#include "PruebaQueSerxaUnaSala__pfDw1773622777.h"
...
APruebaQueSerxaUnaSala_C__pfDw1773622777::APruebaQueSerxaUnaSala_C__pfDw1773622777(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APruebaQueSerxaUnaSala_C__pfDw1773622777::StaticClass() == GetClass()))
	{
		APruebaQueSerxaUnaSala_C__pfDw1773622777::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APruebaQueSerxaUnaSala_C__pfDw1773622777::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
...
void APruebaQueSerxaUnaSala_C__pfDw1773622777::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APruebaQueSerxaUnaSala_C__pfDw1773622777::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__7.ComponentPropertyName = FName(TEXT("StaticMesh"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APruebaQueSerxaUnaSala_C__pfDw1773622777::bpf__ExecuteUbergraph_PruebaQueSerxaUnaSala__pfDw_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(bpv__Posicion__pf.bpv__X_3_ED5DB43747FA6919F00C359E3381C62C__pf, bpfv__CallFunc_Multiply_IntInt_ReturnValue__pf);
	bpv__PosicionIndex__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	...
	b0l__K2Node_DynamicCast_AsMap__pf = Cast<UMap_C__pf2402407856>(((::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf)) ? (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->MapWidget) : (__Local__8)));
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsMap__pf != nullptr);;
	...
	{
		b0l__K2Node_DynamicCast_AsMap__pf->bpf__EnNuevaPosicion__pf(bpfv__CallFunc_Add_IntInt_ReturnValue__pf, ((UTexture2D*)nullptr));
	}
	return; // KCST_GotoReturn
}
void APruebaQueSerxaUnaSala_C__pfDw1773622777::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_PruebaQueSerxaUnaSala__pfDw_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void APruebaQueSerxaUnaSala_C__pfDw1773622777::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APruebaQueSerxaUnaSala_C__pfDw1773622777::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APruebaQueSerxaUnaSala_C__pfDw1773622777
{
	FRegisterHelper__APruebaQueSerxaUnaSala_C__pfDw1773622777()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/Blueprints/PruebaQueSeríaUnaSala"), &APruebaQueSerxaUnaSala_C__pfDw1773622777::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APruebaQueSerxaUnaSala_C__pfDw1773622777 Instance;
};
FRegisterHelper__APruebaQueSerxaUnaSala_C__pfDw1773622777 FRegisterHelper__APruebaQueSerxaUnaSala_C__pfDw1773622777::Instance;
