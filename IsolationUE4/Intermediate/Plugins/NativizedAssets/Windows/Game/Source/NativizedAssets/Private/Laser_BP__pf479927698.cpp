...
ALaser_BP_C__pf479927698::ALaser_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ALaser_BP_C__pf479927698::StaticClass() == GetClass()))
	{
		ALaser_BP_C__pf479927698::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__DefaultSceneRoot__pf = CreateDefaultSubobject<USceneComponent>(TEXT("DefaultSceneRoot"));
	bpv__Cilindro__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Cilindro"));
	...
	bpv__Cilindro__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Cilindro__pf->AttachToComponent(bpv__DefaultSceneRoot__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Cilindro__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALaser_BP_C__pf479927698::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cilindro__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cilindro__pf->OverrideMaterials.Reserve(1);
	bpv__Cilindro__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ALaser_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Cilindro__pf->SetCollisionProfileName(FName(TEXT("OverlapAll")));
	bpv__Cilindro__pf->RelativeScale3D = FVector(0.156154, 0.156154, 5.163898);
	(((UBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Cilindro__pf), true, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void ALaser_BP_C__pf479927698::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__Cilindro__pf)
	{
		bpv__Cilindro__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ALaser_BP_C__pf479927698::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__4.ComponentPropertyName = FName(TEXT("Cilindro"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Cilindro_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ALaser_BP_C__pf479927698::bpf__ExecuteUbergraph_Laser_BP__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ALaser_BP_C__pf479927698::bpf__BndEvt__Cilindro_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Laser_BP__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ALaser_BP_C__pf479927698::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ALaser_BP_C__pf479927698::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ALaser_BP_C__pf479927698
{
	FRegisterHelper__ALaser_BP_C__pf479927698()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/GameplayMechanics/Laser_BP"), &ALaser_BP_C__pf479927698::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ALaser_BP_C__pf479927698 Instance;
};
FRegisterHelper__ALaser_BP_C__pf479927698 FRegisterHelper__ALaser_BP_C__pf479927698::Instance;
