...
#include "Nivel_Laser02__pf626307183.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/TopDownCPP/Niveles/Nivel_Laser02.Nivel_Laser02_C", OverrideNativeName="Nivel_Laser02_C"))
class ANivel_Laser02_C__pf626307183 : public ANivel
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser32"))
	UChildActorComponent* bpv__Laser32__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser31"))
	UChildActorComponent* bpv__Laser31__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser30"))
	UChildActorComponent* bpv__Laser30__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser29"))
	UChildActorComponent* bpv__Laser29__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser28"))
	UChildActorComponent* bpv__Laser28__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser27"))
	UChildActorComponent* bpv__Laser27__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser26"))
	UChildActorComponent* bpv__Laser26__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser25"))
	UChildActorComponent* bpv__Laser25__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser24"))
	UChildActorComponent* bpv__Laser24__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="SpheraGiratoria"))
	USphereComponent* bpv__SpheraGiratoria__pf;
	...
	ANivel_Laser02_C__pf626307183(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_5(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Nivel_Laser02_6"))
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_7(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_8(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_9(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser02__pf_10(int32 bpp__EntryPoint__pf);
