...
ALockerYellow_BP_C__pf479927698::ALockerYellow_BP_C__pf479927698(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ALockerYellow_BP_C__pf479927698::StaticClass() == GetClass()))
	{
		ALockerYellow_BP_C__pf479927698::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	if(__Local__0)
	{
		...
		__Local__7 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__Puerta2__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Puerta2"));
	bpv__Puerta3__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Puerta3"));
	bpv__Puerta4__pf = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("Puerta4"));
	...
	__Local__30 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	__Local__31 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Puerta1__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Puerta1__pf->OverrideMaterials.Reserve(1);
	bpv__Puerta1__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__Puerta1__pf->RelativeLocation = FVector(-43.563976, 1.760561, 0.734283);
	bpv__Puerta1__pf->RelativeScale3D = FVector(0.135459, 1.000000, 0.975125);
	(((UBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__Puerta1__pf), true, 0));
	bpv__Puerta2__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Puerta2__pf->AttachToComponent(bpv__Puerta__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__32 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Puerta2__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__32 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Puerta2__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Puerta2__pf->OverrideMaterials.Reserve(1);
	bpv__Puerta2__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__Puerta2__pf->RelativeLocation = FVector(44.014519, 1.760251, 0.734283);
	bpv__Puerta2__pf->RelativeScale3D = FVector(0.135459, 1.000000, 0.975125);
	(((UBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__Puerta2__pf), true, 0));
	bpv__Puerta3__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Puerta3__pf->AttachToComponent(bpv__Puerta__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__33 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Puerta3__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__33 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Puerta3__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Puerta3__pf->OverrideMaterials.Reserve(1);
	bpv__Puerta3__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__Puerta3__pf->RelativeLocation = FVector(0.208605, 1.767615, -47.103176);
	bpv__Puerta3__pf->RelativeRotation = FRotator(-90.000000, 180.000000, 180.000000);
	bpv__Puerta3__pf->RelativeScale3D = FVector(0.135459, 1.000000, 0.385758);
	(((UBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__Puerta3__pf), true, 0));
	bpv__Puerta4__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Puerta4__pf->AttachToComponent(bpv__Puerta__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__34 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Puerta4__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__34 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__Puerta4__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Puerta4__pf->OverrideMaterials.Reserve(1);
	bpv__Puerta4__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__Puerta4__pf->RelativeLocation = FVector(0.208472, 1.767559, 47.726471);
	bpv__Puerta4__pf->RelativeRotation = FRotator(-90.000000, 180.000000, 180.000000);
	bpv__Puerta4__pf->RelativeScale3D = FVector(0.135459, 1.000000, 0.385758);
	(((UBoolProperty*)__Local__28)->SetPropertyValue_InContainer((bpv__Puerta4__pf), true, 0));
	bpv__Rotar_NewTrack_0_F98A4CBC41AF105218BA9FBF01F003F3__pf = 0.000000f;
	bpv__Rotar__Direction_F98A4CBC41AF105218BA9FBF01F003F3__pf = ETimelineDirection::Type::Forward;
...
void ALockerYellow_BP_C__pf479927698::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ALockerYellow_BP_C__pf479927698::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__35 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"), (EObjectFlags)0x00280029);
	InDynamicClass->ComponentTemplates.Add(__Local__35);
	auto __Local__36 = NewObject<UTimelineTemplate>(InDynamicClass, UTimelineTemplate::StaticClass(), TEXT("Rotar_Template"), (EObjectFlags)0x00280008);
	InDynamicClass->Timelines.Add(__Local__36);
	...
	(((UBoolProperty*)__Local__37)->SetPropertyValue_InContainer((__Local__35), false, 0));
	__Local__36->TimelineLength = 1.250000f;
	__Local__36->FloatTracks = TArray<FTTFloatTrack> ();
	__Local__36->FloatTracks.AddUninitialized(1);
	FTTFloatTrack::StaticStruct()->InitializeStruct(__Local__36->FloatTracks.GetData(), 1);
	auto& __Local__39 = __Local__36->FloatTracks[0];
	auto __Local__40 = NewObject<UCurveFloat>(InDynamicClass, UCurveFloat::StaticClass(), TEXT("CurveFloat_0"), (EObjectFlags)0x00280009);
	InDynamicClass->MiscConvertedSubobjects.Add(__Local__40);
	__Local__40->FloatCurve.Keys = TArray<FRichCurveKey> ();
	__Local__40->FloatCurve.Keys.AddUninitialized(2);
	FRichCurveKey::StaticStruct()->InitializeStruct(__Local__40->FloatCurve.Keys.GetData(), 2);
	auto& __Local__41 = __Local__40->FloatCurve.Keys[0];
	auto& __Local__42 = __Local__40->FloatCurve.Keys[1];
	__Local__42.Time = 1.250000f;
	__Local__42.Value = 90.000000f;
	__Local__39.CurveFloat = __Local__40;
	auto& __Local__43 = (*(AccessPrivateProperty<FName >(&(__Local__39), FTTPropertyTrack::__PPO__PropertyName() )));
	__Local__43 = FName(TEXT("Rotar_NewTrack_0_F98A4CBC41AF105218BA9FBF01F003F3"));
	auto& __Local__44 = (*(AccessPrivateProperty<FName >(&(__Local__39), FTTTrackBase::__PPO__TrackName() )));
	__Local__44 = FName(TEXT("NewTrack_0"));
	__Local__36->TimelineGuid = FGuid(0xF98A4CBC, 0x41AF1052, 0x18BA9FBF, 0x01F003F3);
	auto& __Local__45 = (*(AccessPrivateProperty<FName >((__Local__36), UTimelineTemplate::__PPO__VariableName() )));
	__Local__45 = FName(TEXT("Rotar"));
	auto& __Local__46 = (*(AccessPrivateProperty<FName >((__Local__36), UTimelineTemplate::__PPO__DirectionPropertyName() )));
	__Local__46 = FName(TEXT("Rotar__Direction_F98A4CBC41AF105218BA9FBF01F003F3"));
	auto& __Local__47 = (*(AccessPrivateProperty<FName >((__Local__36), UTimelineTemplate::__PPO__UpdateFunctionName() )));
	__Local__47 = FName(TEXT("Rotar__UpdateFunc"));
	auto& __Local__48 = (*(AccessPrivateProperty<FName >((__Local__36), UTimelineTemplate::__PPO__FinishedFunctionName() )));
	__Local__48 = FName(TEXT("Rotar__FinishedFunc"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 19:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf != nullptr);;
		...
		case 20:
			{
				int32  __Local__49 = 0;
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf)) ? (b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf->bpv__LlavesAmarillas__pf) : (__Local__49)), 1);
		...
		case 21:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsTop_Down_Character_1__pf->bpv__LlavesAmarillas__pf = b0l__Temp_int_Variable__pf;
				}
			}
		case 22:
			{
		...
		case 24:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsTop_Down_Character_2__pf != nullptr);;
		...
		case 25:
			{
				USkeletalMeshComponent*  __Local__50 = ((USkeletalMeshComponent*)nullptr);
				b0l__CallFunc_CreateProxyObjectForPlayMontage_ReturnValue__pf = UPlayMontageCallbackProxy::CreateProxyObjectForPlayMontage(((::IsValid(b0l__K2Node_DynamicCast_AsTop_Down_Character_2__pf)) ? ((*(AccessPrivateProperty<USkeletalMeshComponent* >((b0l__K2Node_DynamicCast_AsTop_Down_Character_2__pf), ACharacter::__PPO__Mesh() )))) : (__Local__50)), CastChecked<UAnimMontage>(CastChecked<UDynamicClass>(ALockerYellow_BP_C__pf479927698::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), 1.000000, 0.000000, FName(TEXT("Taking_Item")));
			}
		case 26:
			{
		...
		case 27:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_4__pf.BindUFunction(this,FName(TEXT("OnCompleted_EACC409E4A012D1FA543689231ECB68B")));
		...
		case 28:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_3__pf.BindUFunction(this,FName(TEXT("OnBlendOut_EACC409E4A012D1FA543689231ECB68B")));
				if(::IsValid(b0l__CallFunc_CreateProxyObjectForPlayMontage_ReturnValue__pf))
				{
		...
		case 29:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_2__pf.BindUFunction(this,FName(TEXT("OnInterrupted_EACC409E4A012D1FA543689231ECB68B")));
				if(::IsValid(b0l__CallFunc_CreateProxyObjectForPlayMontage_ReturnValue__pf))
				{
		...
		case 30:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate_1__pf.BindUFunction(this,FName(TEXT("OnNotifyBegin_EACC409E4A012D1FA543689231ECB68B")));
				if(::IsValid(b0l__CallFunc_CreateProxyObjectForPlayMontage_ReturnValue__pf))
				{
		...
		case 31:
			{
				b0l__K2Node_CreateDelegate_OutputDelegate__pf.BindUFunction(this,FName(TEXT("OnNotifyEnd_EACC409E4A012D1FA543689231ECB68B")));
				if(::IsValid(b0l__CallFunc_CreateProxyObjectForPlayMontage_ReturnValue__pf))
				{
...
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 34);
	return; // KCST_GotoReturn
}
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_2(int32 bpp__EntryPoint__pf)
{
	FRotator bpfv__CallFunc_MakeRotator_ReturnValue__pf(EForceInit::ForceInit);
	check(bpp__EntryPoint__pf == 33);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_MakeRotator_ReturnValue__pf = UKismetMathLibrary::MakeRotator(0.000000, 0.000000, bpv__Rotar_NewTrack_0_F98A4CBC41AF105218BA9FBF01F003F3__pf);
...
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_3(int32 bpp__EntryPoint__pf)
{
...
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_4(int32 bpp__EntryPoint__pf)
{
...
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_5(int32 bpp__EntryPoint__pf)
{
...
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_6(int32 bpp__EntryPoint__pf)
{
...
void ALockerYellow_BP_C__pf479927698::bpf__ExecuteUbergraph_LockerYellow_BP__pf_7(int32 bpp__EntryPoint__pf)
{
...
void ALockerYellow_BP_C__pf479927698::bpf__InteraccionBlueprint__pf()
{
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_0(14);
}
void ALockerYellow_BP_C__pf479927698::bpf__OnCompleted_EACC409E4A012D1FA543689231ECB68B__pf(FName bpp__NotifyName__pf)
{
	b0l__K2Node_CustomEvent_NotifyName__pf = bpp__NotifyName__pf;
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_3(11);
}
void ALockerYellow_BP_C__pf479927698::bpf__OnBlendOut_EACC409E4A012D1FA543689231ECB68B__pf(FName bpp__NotifyName__pf)
{
	b0l__K2Node_CustomEvent_NotifyName_1__pf = bpp__NotifyName__pf;
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_4(9);
}
void ALockerYellow_BP_C__pf479927698::bpf__OnInterrupted_EACC409E4A012D1FA543689231ECB68B__pf(FName bpp__NotifyName__pf)
{
	b0l__K2Node_CustomEvent_NotifyName_2__pf = bpp__NotifyName__pf;
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_5(7);
}
void ALockerYellow_BP_C__pf479927698::bpf__OnNotifyBegin_EACC409E4A012D1FA543689231ECB68B__pf(FName bpp__NotifyName__pf)
{
	b0l__K2Node_CustomEvent_NotifyName_3__pf = bpp__NotifyName__pf;
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_6(5);
}
void ALockerYellow_BP_C__pf479927698::bpf__OnNotifyEnd_EACC409E4A012D1FA543689231ECB68B__pf(FName bpp__NotifyName__pf)
{
	b0l__K2Node_CustomEvent_NotifyName_4__pf = bpp__NotifyName__pf;
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_7(3);
}
void ALockerYellow_BP_C__pf479927698::bpf__Rotar__UpdateFunc__pf()
{
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_2(33);
}
void ALockerYellow_BP_C__pf479927698::bpf__Rotar__FinishedFunc__pf()
{
	bpf__ExecuteUbergraph_LockerYellow_BP__pf_1(34);
}
PRAGMA_DISABLE_OPTIMIZATION
void ALockerYellow_BP_C__pf479927698::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ALockerYellow_BP_C__pf479927698::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ALockerYellow_BP_C__pf479927698
{
	FRegisterHelper__ALockerYellow_BP_C__pf479927698()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/GameplayMechanics/LockerYellow_BP"), &ALockerYellow_BP_C__pf479927698::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ALockerYellow_BP_C__pf479927698 Instance;
};
FRegisterHelper__ALockerYellow_BP_C__pf479927698 FRegisterHelper__ALockerYellow_BP_C__pf479927698::Instance;
