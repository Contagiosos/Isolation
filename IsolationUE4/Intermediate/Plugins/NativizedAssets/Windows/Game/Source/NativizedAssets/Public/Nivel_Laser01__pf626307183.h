...
#include "Nivel_Laser01__pf626307183.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/TopDownCPP/Niveles/Nivel_Laser01.Nivel_Laser01_C", OverrideNativeName="Nivel_Laser01_C"))
class ANivel_Laser01_C__pf626307183 : public ANivel
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser34A1"))
	UChildActorComponent* bpv__Laser34A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser33A1"))
	UChildActorComponent* bpv__Laser33A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser32A1"))
	UChildActorComponent* bpv__Laser32A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser31A1"))
	UChildActorComponent* bpv__Laser31A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser30A1"))
	UChildActorComponent* bpv__Laser30A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser29A1"))
	UChildActorComponent* bpv__Laser29A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LASERMEDIO1"))
	UChildActorComponent* bpv__LASERMEDIO1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser28A1"))
	UChildActorComponent* bpv__Laser28A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser27A1"))
	UChildActorComponent* bpv__Laser27A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser26A1"))
	UChildActorComponent* bpv__Laser26A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser25A1"))
	UChildActorComponent* bpv__Laser25A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser24A1"))
	UChildActorComponent* bpv__Laser24A1__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser0A1"))
	UChildActorComponent* bpv__Laser0A1__pf;
	...
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser34A"))
	UChildActorComponent* bpv__Laser34A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser33A"))
	UChildActorComponent* bpv__Laser33A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser32A"))
	UChildActorComponent* bpv__Laser32A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser31A"))
	UChildActorComponent* bpv__Laser31A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser30A"))
	UChildActorComponent* bpv__Laser30A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser29A"))
	UChildActorComponent* bpv__Laser29A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="LASERMEDIO"))
	UChildActorComponent* bpv__LASERMEDIO__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser28A"))
	UChildActorComponent* bpv__Laser28A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser27A"))
	UChildActorComponent* bpv__Laser27A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser26A"))
	UChildActorComponent* bpv__Laser26A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser25A"))
	UChildActorComponent* bpv__Laser25A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser24A"))
	UChildActorComponent* bpv__Laser24A__pf;
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Laser0A"))
	UChildActorComponent* bpv__Laser0A__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_K2_AddRelativeLocation_SweepHitResult_1"))
	FHitResult b0l__CallFunc_K2_AddRelativeLocation_SweepHitResult_1__pf;
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_K2_AddRelativeLocation_SweepHitResult_2"))
	FHitResult b0l__CallFunc_K2_AddRelativeLocation_SweepHitResult_2__pf;
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="CallFunc_K2_AddRelativeLocation_SweepHitResult_3"))
	FHitResult b0l__CallFunc_K2_AddRelativeLocation_SweepHitResult_3__pf;
	...
	AVolumetrics_BP_C__pf2692903288* b0l__CallFunc_Array_Get_Item_4__pf;
	...
	ANivel_Laser01_C__pf626307183(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_2(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_3(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_4(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_5(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_6(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_7(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Nivel_Laser01_8"))
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_8(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_9(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_10(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_11(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Nivel_Laser01__pf_12(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="BndEvt__BoxCollisionPlaca1_K2Node_ComponentBoundEvent_5_ComponentEndOverlapSignature__DelegateSignature"))
	virtual void bpf__BndEvt__BoxCollisionPlaca1_K2Node_ComponentBoundEvent_5_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf);
	UFUNCTION(meta=(OverrideNativeName="BndEvt__BoxCollisionPlaca0_K2Node_ComponentBoundEvent_4_ComponentEndOverlapSignature__DelegateSignature"))
	virtual void bpf__BndEvt__BoxCollisionPlaca0_K2Node_ComponentBoundEvent_4_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf);
