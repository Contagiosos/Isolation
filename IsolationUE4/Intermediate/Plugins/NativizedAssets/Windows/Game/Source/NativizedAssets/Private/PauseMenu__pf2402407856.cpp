...
UPauseMenu_C__pf2402407856::UPauseMenu_C__pf2402407856(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (UPauseMenu_C__pf2402407856::StaticClass() == GetClass()))
	{
		UPauseMenu_C__pf2402407856::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__BotonContinuar__pf = nullptr;
	bpv__BotonOpciones__pf = nullptr;
	bpv__BotonSalir_1__pf = nullptr;
...
void UPauseMenu_C__pf2402407856::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UPauseMenu_C__pf2402407856::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__2.ComponentPropertyName = FName(TEXT("BotonContinuar"));
	__Local__2.DelegatePropertyName = FName(TEXT("OnReleased"));
	__Local__2.FunctionNameToBind = FName(TEXT("BndEvt__BotonContinuar_K2Node_ComponentBoundEvent_0_OnButtonReleasedEvent__DelegateSignature"));
	auto& __Local__3 = __Local__0->ComponentDelegateBindings[1];
	__Local__3.ComponentPropertyName = FName(TEXT("BotonOpciones"));
	__Local__3.DelegatePropertyName = FName(TEXT("OnReleased"));
	__Local__3.FunctionNameToBind = FName(TEXT("BndEvt__BotonOpciones_K2Node_ComponentBoundEvent_1_OnButtonReleasedEvent__DelegateSignature"));
	auto& __Local__4 = __Local__0->ComponentDelegateBindings[2];
	__Local__4.ComponentPropertyName = FName(TEXT("BotonSalir_1"));
	__Local__4.DelegatePropertyName = FName(TEXT("OnReleased"));
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__BotonSalir_1_K2Node_ComponentBoundEvent_2_OnButtonReleasedEvent__DelegateSignature"));
	auto& __Local__5 = __Local__0->ComponentDelegateBindings[3];
	__Local__5.ComponentPropertyName = FName(TEXT("BotonVolver"));
	__Local__5.DelegatePropertyName = FName(TEXT("OnReleased"));
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__BotonVolver_K2Node_ComponentBoundEvent_3_OnButtonReleasedEvent__DelegateSignature"));
	...
	auto __Local__8 = NewObject<UCanvasPanelSlot>(__Local__6, UCanvasPanelSlot::StaticClass(), TEXT("CanvasPanelSlot_5"), (EObjectFlags)0x00280008);
	__Local__8->LayoutData.Offsets.Left = -964.000000f;
	__Local__8->LayoutData.Offsets.Top = -544.000000f;
	...
	auto __Local__20 = NewObject<UButton>(__Local__1, UButton::StaticClass(), TEXT("BotonContinuar"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[28CE88634BD7B660BE950B968FA2E548]\", \"5B0287D0453975030E897DB38073964F\", \"Continuar\")")	);
	...
	auto __Local__27 = NewObject<UVerticalBoxSlot>(__Local__12, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_3"), (EObjectFlags)0x00280008);
	...
	auto __Local__28 = NewObject<UHorizontalBox>(__Local__1, UHorizontalBox::StaticClass(), TEXT("HorizontalBox"), (EObjectFlags)0x00280008);
	...
	auto __Local__31 = NewObject<USpacer>(__Local__1, USpacer::StaticClass(), TEXT("Spacer"), (EObjectFlags)0x00280008);
	...
	auto __Local__33 = NewObject<UButton>(__Local__1, UButton::StaticClass(), TEXT("BotonOpciones"), (EObjectFlags)0x00280008);
	...
	auto __Local__36 = NewObject<UTextBlock>(__Local__1, UTextBlock::StaticClass(), TEXT("TextBlock_273"), (EObjectFlags)0x00280008);
	__Local__36->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[28CE88634BD7B660BE950B968FA2E548]\", \"B834CBA549ED0B3DDE6AAB87FF29DBF5\", \"Opciones\")")	);
	...
	auto __Local__39 = NewObject<USpacer>(__Local__1, USpacer::StaticClass(), TEXT("Spacer_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__40 = NewObject<UVerticalBoxSlot>(__Local__12, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_0"), (EObjectFlags)0x00280008);
	...
	auto __Local__41 = NewObject<UHorizontalBox>(__Local__1, UHorizontalBox::StaticClass(), TEXT("HorizontalBox_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__44 = NewObject<USpacer>(__Local__1, USpacer::StaticClass(), TEXT("Spacer_2"), (EObjectFlags)0x00280008);
	...
	auto __Local__46 = NewObject<UButton>(__Local__1, UButton::StaticClass(), TEXT("BotonSalir_1"), (EObjectFlags)0x00280008);
	...
	auto __Local__49 = NewObject<UTextBlock>(__Local__1, UTextBlock::StaticClass(), TEXT("TextBlock"), (EObjectFlags)0x00280008);
	__Local__49->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[28CE88634BD7B660BE950B968FA2E548]\", \"C0A57C7A4569987279FAE6916D81F4B2\", \"Salir\")")	);
	...
	auto __Local__52 = NewObject<USpacer>(__Local__1, USpacer::StaticClass(), TEXT("Spacer_3"), (EObjectFlags)0x00280008);
	...
	auto __Local__53 = NewObject<UWidgetSwitcherSlot>(__Local__9, UWidgetSwitcherSlot::StaticClass(), TEXT("WidgetSwitcherSlot_2"), (EObjectFlags)0x00280008);
	__Local__53->Parent = __Local__9;
	auto __Local__54 = NewObject<UVerticalBox>(__Local__1, UVerticalBox::StaticClass(), TEXT("VerticalBox_64"), (EObjectFlags)0x00280008);
	...
	auto __Local__58 = NewObject<UVerticalBoxSlot>(__Local__54, UVerticalBoxSlot::StaticClass(), TEXT("VerticalBoxSlot_2"), (EObjectFlags)0x00280008);
...
TEXT("NSLOCTEXT(\"[28CE88634BD7B660BE950B968FA2E548]\", \"7016137C448F1BDA0C49419D45CC04E7\", \"Volver\")")	);
...
PRAGMA_ENABLE_OPTIMIZATION
void UPauseMenu_C__pf2402407856::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__69;
	SlotNames.Append(__Local__69);
}
void UPauseMenu_C__pf2402407856::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__70;
	TArray<FDelegateRuntimeBinding>  __Local__71;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), false, true, CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UPauseMenu_C__pf2402407856::StaticClass())->MiscConvertedSubobjects[0]), __Local__70, __Local__71);
}
void UPauseMenu_C__pf2402407856::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UPauseMenu_C__pf2402407856::bpf__ExecuteUbergraph_PauseMenu__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->bpf__Pausa__pf();
	}
	return; // KCST_GotoReturn
}
void UPauseMenu_C__pf2402407856::bpf__ExecuteUbergraph_PauseMenu__pf_1(int32 bpp__EntryPoint__pf)
{
		...
		case 2:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf))
				{
					...
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->bpf__CambiarVolumen__pf(((::IsValid(bpv__OptionsWidget__pf)) ? (bpv__OptionsWidget__pf->bpv__VolumenMusica__pf) : (__Local__72)), ((::IsValid(bpv__OptionsWidget__pf)) ? (bpv__OptionsWidget__pf->bpv__VolumenSonido__pf) : (__Local__73)));
				}
				__CurrentState = -1;
				break;
			}
		...
		case 12:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsUser_Settings__pf != nullptr);;
		...
		case 13:
			{
				...
				{
					bpv__OptionsWidget__pf->bpv__VolumenMusica__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsUser_Settings__pf)) ? (b0l__K2Node_DynamicCast_AsUser_Settings__pf->bpv__VolumenMusica__pf) : (__Local__74));
				}
			}
		case 14:
			{
				if(::IsValid(bpv__OptionsWidget__pf) && ::IsValid(bpv__OptionsWidget__pf->bpv__Slider2__pf))
				{
					...
					bpv__OptionsWidget__pf->bpv__Slider2__pf->USlider::SetValue(((::IsValid(b0l__K2Node_DynamicCast_AsUser_Settings__pf)) ? (b0l__K2Node_DynamicCast_AsUser_Settings__pf->bpv__VolumenMusica__pf) : (__Local__75)));
				}
			}
		case 15:
			{
				...
				if(::IsValid(bpv__OptionsWidget__pf))
				{
					bpv__OptionsWidget__pf->bpv__VolumenSonido__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsUser_Settings__pf)) ? (b0l__K2Node_DynamicCast_AsUser_Settings__pf->bpv__VolumenSonido__pf) : (__Local__76));
				}
			}
		case 16:
			{
				if(::IsValid(bpv__OptionsWidget__pf) && ::IsValid(bpv__OptionsWidget__pf->bpv__Slide1__pf))
				{
					...
					bpv__OptionsWidget__pf->bpv__Slide1__pf->USlider::SetValue(((::IsValid(b0l__K2Node_DynamicCast_AsUser_Settings__pf)) ? (b0l__K2Node_DynamicCast_AsUser_Settings__pf->bpv__VolumenSonido__pf) : (__Local__77)));
				}
				__CurrentState = 1;
				break;
			}
...
void UPauseMenu_C__pf2402407856::bpf__ExecuteUbergraph_PauseMenu__pf_2(int32 bpp__EntryPoint__pf)
{
...
void UPauseMenu_C__pf2402407856::bpf__ExecuteUbergraph_PauseMenu__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpv__UserSettings__pf->bpv__VolumenMusica__pf = ((::IsValid(bpv__OptionsWidget__pf)) ? (bpv__OptionsWidget__pf->bpv__VolumenMusica__pf) : (__Local__78));
	}
	float  __Local__79 = 0.000000;
	if(::IsValid(bpv__UserSettings__pf))
	{
		bpv__UserSettings__pf->bpv__VolumenSonido__pf = ((::IsValid(bpv__OptionsWidget__pf)) ? (bpv__OptionsWidget__pf->bpv__VolumenSonido__pf) : (__Local__79));
	}
	// optimized KCST_UnconditionalGoto
...
void UPauseMenu_C__pf2402407856::bpf__BndEvt__BotonContinuar_K2Node_ComponentBoundEvent_0_OnButtonReleasedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseMenu__pf_0(26);
}
void UPauseMenu_C__pf2402407856::bpf__BndEvt__BotonOpciones_K2Node_ComponentBoundEvent_1_OnButtonReleasedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseMenu__pf_1(25);
}
void UPauseMenu_C__pf2402407856::bpf__BndEvt__BotonSalir_1_K2Node_ComponentBoundEvent_2_OnButtonReleasedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseMenu__pf_2(24);
}
void UPauseMenu_C__pf2402407856::bpf__BndEvt__BotonVolver_K2Node_ComponentBoundEvent_3_OnButtonReleasedEvent__DelegateSignature__pf()
{
	bpf__ExecuteUbergraph_PauseMenu__pf_3(18);
}
PRAGMA_DISABLE_OPTIMIZATION
void UPauseMenu_C__pf2402407856::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UPauseMenu_C__pf2402407856::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UPauseMenu_C__pf2402407856
{
	FRegisterHelper__UPauseMenu_C__pf2402407856()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/HUD/PauseMenu"), &UPauseMenu_C__pf2402407856::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UPauseMenu_C__pf2402407856 Instance;
};
FRegisterHelper__UPauseMenu_C__pf2402407856 FRegisterHelper__UPauseMenu_C__pf2402407856::Instance;
