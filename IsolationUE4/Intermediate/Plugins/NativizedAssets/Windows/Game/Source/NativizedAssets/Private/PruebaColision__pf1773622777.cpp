...
APruebaColision_C__pf1773622777::APruebaColision_C__pf1773622777(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APruebaColision_C__pf1773622777::StaticClass() == GetClass()))
	{
		APruebaColision_C__pf1773622777::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APruebaColision_C__pf1773622777::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	bpv__BoxCollision__pf->AttachToComponent(bpv__StaticMesh__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__BoxCollision__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	bpv__BoxCollision__pf->RelativeLocation = FVector(0.000000, 70.000000, 0.000000);
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__BoxCollision__pf), true, 0));
}
PRAGMA_ENABLE_OPTIMIZATION
void APruebaColision_C__pf1773622777::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APruebaColision_C__pf1773622777::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__4->ComponentDelegateBindings.AddUninitialized(2);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__4->ComponentDelegateBindings.GetData(), 2);
	auto& __Local__7 = __Local__4->ComponentDelegateBindings[0];
	__Local__7.ComponentPropertyName = FName(TEXT("BoxCollision"));
	__Local__7.DelegatePropertyName = FName(TEXT("OnComponentEndOverlap"));
	__Local__7.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature"));
	auto& __Local__8 = __Local__4->ComponentDelegateBindings[1];
	__Local__8.ComponentPropertyName = FName(TEXT("BoxCollision"));
	__Local__8.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__8.FunctionNameToBind = FName(TEXT("BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APruebaColision_C__pf1773622777::bpf__ExecuteUbergraph_PruebaColision__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				UKismetSystemLibrary::Delay(this, 0.050000, FLatentActionInfo(2, 1275771543, TEXT("ExecuteUbergraph_PruebaColision_0"), this));
				__CurrentState = -1;
				break;
			}
		case 2:
		...
		case 3:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->AMainPlayerController::RemoveInteractWidget();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 13:
			{
				...
				b0l__K2Node_DynamicCast_bSuccess_3__pf = (b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf != nullptr);;
		...
		case 14:
			{
				...
				if(::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf))
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP_1__pf->InteractLocation = bpfv__CallFunc_K2_GetActorLocation_ReturnValue_1__pf;
				}
				__CurrentState = 1;
				break;
			}
...
void APruebaColision_C__pf1773622777::bpf__ExecuteUbergraph_PruebaColision__pf_1(int32 bpp__EntryPoint__pf)
{
		...
		case 5:
			{
				...
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->AMainPlayerController::DisplayInteractWidget();
				}
				__CurrentState = -1;
				break;
			}
		...
		case 9:
			{
				...
				if(::IsValid(b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf))
				{
					b0l__K2Node_DynamicCast_AsMain_Player_Controller_BP__pf->InteractLocation = bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf;
				}
			}
		case 10:
			{
				UKismetSystemLibrary::Delay(this, 0.050000, FLatentActionInfo(4, -873124958, TEXT("ExecuteUbergraph_PruebaColision_1"), this));
				__CurrentState = -1;
				break;
			}
		default:
...
void APruebaColision_C__pf1773622777::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_PruebaColision__pf_0(11);
}
void APruebaColision_C__pf1773622777::bpf__BndEvt__BoxCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_PruebaColision__pf_1(6);
}
PRAGMA_DISABLE_OPTIMIZATION
void APruebaColision_C__pf1773622777::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APruebaColision_C__pf1773622777::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APruebaColision_C__pf1773622777
{
	FRegisterHelper__APruebaColision_C__pf1773622777()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownCPP/Blueprints/PruebaColision"), &APruebaColision_C__pf1773622777::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APruebaColision_C__pf1773622777 Instance;
};
FRegisterHelper__APruebaColision_C__pf1773622777 FRegisterHelper__APruebaColision_C__pf1773622777::Instance;
